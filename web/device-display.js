...
(function (root) {
  ...
  var PLATFORMS = { win: true, mac: true, linux: true, cloud: true, unknown: true };
  ...
  function osIconSvg(platform) {
    ...
    if (platform === "cloud") {
      // A filled cloud in currentColor, sized like the others. Deliberately not
      // the penguin: the machine's operating system is our business, not the
      // reader's, and the row should say what the thing IS.
      return '<svg viewBox="0 0 24 24" aria-hidden="true">' +
        '<path fill="currentColor" d="M6.5,19.5A4.5,4.5 0 0,1 2,15A4.5,4.5 0 0,1 6.5,10.5C6.7,10.5 6.9,10.5 7.1,10.6A5.5,5.5 0 0,1 12.5,6A5.5,5.5 0 0,1 18,11.2A3.9,3.9 0 0,1 21.5,15.1A4.4,4.4 0 0,1 17.1,19.5Z"/>' +
        "</svg>";
    }
    if (platform === "linux") {
